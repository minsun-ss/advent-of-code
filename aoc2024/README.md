...
I have dispensed with the map, imports etc stuff nowadays in python. These days I'm very into just using standard library if I can get away with it in general, or better yet, no imports at all, standard or otherwise. If I can get a puzzle done with zero imports, even better, although towards the end I was using lru_cache quite a bit. functools, itertools, and collections 
...
- Day 19 - this time was truly stuck becaues am not great at dynamic programming. Had to read a working solution in order to understand it. To add to study.
...
- Optimize 6 and 20, they take too long. 6 has one easy optimization I could do (end early once I
